    ...
    <main class="container">
        ...
        <div class="border row position-relative">
            ...
            <div class="content col-lg-9">
                <header class="header">
                    <div class="balance mb-3 mb-sm-0"><img src="assets/img/calc-logo.png" alt=""><span>BALANCE:<br>Your balance is <b>
<?php echo $userRow['account_bal']; ?></b> <small>USD</small></span></div>
                   
                </header>

<p class="page-title" style="/*! font-size: 14px; */font-weight: 400;text-transform: initial;">In your dashboard, you can manage your investments, change your account settings, and access your deposit and referral statistics. Use the Make a Deposit and Withdrawal tabs to deposit funds and request a profit payout to your wallet.</p><b class="page-title">Transaction log:</b><div class="table-overflow"><table class="referals-table"><tbody><tr>
 <td>Investor:</td>
 <td><?php echo $userRow['username']; ?></td>
</tr><tr>
 <td>StartUp Date:</td>
 <td>
<?php echo $userRow['account_date']; ?></td>
</tr><tr>
 
</tr><tr>
 <td valign=top>Cummulative Balance:</td>
 <td>$<b>
<?php echo $userRow['account_bal']; ?></b><br>
 <small>
               </tr><tr>
 <td>Total Earned:</td>
 <td>$<b>
<?php echo $userRow['earnings']; ?></b></td>
</tr><tr>
 <td>Pending Withdrawal:</td>
 <td>$<b>
<?php echo $userRow['pending_withdrawal']; ?></b></td>
</tr><tr>
 <td>Total Withdrawn:</td>
 <td>$<b>
<?php echo $userRow['total_withdrawal']; ?></b></td>
</tr><tr>
 <td>Currently Traded Deposit:</td>
 <td>$<b>
<?php echo $userRow['account_bal']; ?></b></td>
</tr>
</tbody></table></div>
</div>
</div>
