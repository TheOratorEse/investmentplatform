...
<tr>
 <td>Plan:</td>
 <td>Qualitative Plan 2</td>
</tr>
<tr>
 <td>Profit:</td>
 <td>2.30% Daily for 30 days </td>
</tr>
<tr>
...
<br><br>
<form name=spend method=post><input type="hidden" name="form_id" value="15987480227240"><input type="hidden" name="form_token" value="75636446e2aa6cd33068fa11e4ebfd71">
<input type=hidden name=a value=deposit>
<input type=hidden name=action value=confirm>
<input type=hidden name=type value=process_1000>
<input type=hidden name=h_id value=8>
