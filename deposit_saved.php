...
<h3>Your deposit is being verified. It would be added to your account as soon as it's confirmed.</h3><br><br>


<form method=post name='spendform'><input type="hidden" name="form_id" value="15987469313461"><input type="hidden" name="form_token" value="5e93d87627af55a3e222b5b1b2d0ca3c"><input type=hidden name=a value=deposit>
    <fieldset>
                    ...
                    <div class="systems row">
                        ...
                        <div class="col-md-4 col-sm-6">
                            ...
                            <div class="system-label">
                                ...
                                <input type="radio" id="pidw1006" name=type value="process_1006" class="ack">

                                <label for="pidw1006" class="system border">

                                    <img src="/images/1006.png" alt="">

                                    <span class="type"></span>

                                    <span class="name">Ethereum Wallet</span>
                            ...
                            <div class="system-label">
                                ...
                                <input type="radio" id="pidw1007" name=type value="process_1007" class="ack">

                                <label for="pidw1007" class="system border">

                                    <img src="/images/1007.png" alt="">

                                    <span class="type"></span>

                                    <span class="name">Litecoin Wallet</span>
                            ...
                            <div class="system-label">
                                ...
                                <input type="radio" id="pidw1008" name=type value="process_1008" class="ack">

                                <label for="pidw1008" class="system border">

                                    <img src="/images/1008.png" alt="">

                                    <span class="type"></span>

                                    <span class="name">Perfect Money Wallet</span>
                            ...
                            <div class="system-label">
                                ...
                                <input type="radio" id="pidw1009" name=type value="process_1009" class="ack">

                                <label for="pidw1009" class="system border">

                                    <img src="/images/1009.png" alt="">

                                    <span class="type"></span>

                                    <span class="name">Payeer Wallet</span>
                    ...
                    <div class="contracts row justify-content-around">
                        ...
                        <div class="col-md-4 col-sm-8">
                            ...
                            <label for="contract-1" class="contract"><span class="title">Legacy Basic</span><span class="upper">Deposit period:</span>
                                ...
                                <br><span class="text">Initial deposit refunded at <br>the end of the term</span>
                        ...
                        <div class="col-md-4 col-sm-8">
                            ...
                            <label for="contract-2" class="contract"><span class="title">Legacy Classic</span><span class="upper">Deposit period:
                                ...
                                <br><span class="text">Initial deposit refunded at <br>the end of the term</span><span class="ok"></span></label>
    ...
    <br>
    <input name="add_btn" value="PAY" type="submit" class="btn-square btn-square--green">
</form>
