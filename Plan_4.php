...
<tr>
 <td>Plan:</td>
 <td>Qualitative Plan 1</td>
</tr>
<tr>
 <td>Profit:</td>
 <td>2.00% Daily for 30 days </td>
</tr>
<tr>
...
<br><br>
<form name=spend method=post><input type="hidden" name="form_id" value="15987479759925"><input type="hidden" name="form_token" value="9136717ee926f6f5910abdc891a5a780">
<input type=hidden name=a value=deposit>
<input type=hidden name=action value=confirm>
<input type=hidden name=type value=process_1000>
<input type=hidden name=h_id value=7>
